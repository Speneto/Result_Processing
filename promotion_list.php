...
//get num row of highest

if($first_term_average_num_rows > $second_term_average_num_rows && $first_term_average_num_rows > $third_term_average_num_rows ){
$size = $first_term_average_num_rows;
}else if ($second_term_average_num_rows > $first_term_average_num_rows && $second_term_average_num_rows > $third_term_average_num_rows ){
$size = $second_term_average_num_rows;
}else if ($third_term_average_num_rows > $first_term_average_num_rows && $third_term_average_num_rows > $second_term_average_num_rows ){
$size = $third_term_average_num_rows;
}
...
if($answer == "promoted"){
$select = mysql_query("Select * From current_class Where ID_Number='$id_number[$i]' and Class='$promoted_to' and Session='$promoted_session3' and Term='FIRST TERM'");
$num_select = mysql_num_rows($select);

if($num_select > 0){
$update_promoted = mysql_query("update current_class set Class='$promoted_to', Session='$promoted_session3', Term='FIRST TERM', Previous_class='$class', Comment='$answer' Where ID_Number='$id_number[$i]' and Class='$promoted_to' and Session='$promoted_session3' and Term='FIRST TERM' ");
}else{
$insert = mysql_query("Insert Into current_class (ID_Number, Class, Session, Term, Previous_class, Comment, Department) VALUES ('$id_number[$i]', '$promoted_to', '$promoted_session3', 'FIRST TERM', '$class', '$answer', '$department')");
}
// WHERE NOT EXISTS (SELECT ID_Number, Class, Session, Term FROM current_class WHERE (ID_Number='$id_number[$i]' and Class='$promoted_to' and Session='$promoted_session3' and Term='FIRST TERM'))");


}elseif($answer == "Not Promoted"){
$select1 = mysql_query("Select * From current_class Where ID_Number='$id_number[$i]' and Class='$current_class' and Session='$promoted_session3' and Term='FIRST TERM'");
$num_select1 = mysql_num_rows($select1);
if($num_select1 > 0){
$update_Not_promoted = mysql_query("update current_class set Class='$current_class', Session='$promoted_session3', Term='FIRST TERM', Previous_class='$class', Comment='$answer'  Where ID_Number='$id_number[$i]' and Class='$current_class' and Session='$promoted_session3' and Term='FIRST TERM'");
}else{
$insert1 = mysql_query("Insert Into current_class (ID_Number, Class, Session, Term, Previous_class, Comment, Department) VALUES ('$id_number[$i]', '$current_class', '$promoted_session3', 'FIRST TERM', '$class', '$answer', '$department')");
}
}
}
?>
