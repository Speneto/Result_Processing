...
$out_standing_fees = mysql_query("Select ID_Number, Balance From fees_sheet Where Term='$term' AND Session='$session' AND Clas='$class' AND Department='$department' AND ID_Number='$name' ");
...
<td width="80" class="style42 style40"><strong>Ratingd(A-E)</strong></td>
...
<tr><td> <?php  $character_id = $row['ID_Number']; for($z=0; $z < $num_character; $z++){if( $character_id == $id_character1[$z]){echo $form_master_remark[$z];}}?> </td> <td><center> <?php echo $nextTerm; ?> </center> </td><td><center><?php echo  $out_standing_fees_amount;  ?></center></td><td><center><?php echo $fees;  ?></center></td></tr>
</table>
<div align="left"><br>
