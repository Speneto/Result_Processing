...
$name = trim(htmlspecialchars(strtoupper($_POST['lst_name'])));
...
$average1 = mysql_query("Select * from final_score_sheet Where Session='$session' AND Class='$class' AND Term ='FIRST TERM' AND ID_Number='$name'");
...
$average2 = mysql_query("Select * from final_score_sheet Where Session='$session' AND Class='$class' AND Term ='SECOND TERM' AND ID_Number='$name'");
...
$average3 = mysql_query("Select * from final_score_sheet Where Session='$session' AND Class='$class' AND Term ='THIRD TERM' AND ID_Number='$name'");
...
$verify = mysql_query("Select * from score_sheet Where score_sheet.Session='$session' AND score_sheet.Class='$class' AND score_sheet.Term='$term' AND score_sheet.ID_Number='$name'");
...
$sql = mysql_query("Select ID_Number, SUM(Total) AS Gtotal, AVG(Total) AS Gaverage, COUNT(Subj_ID) AS Subj FROM score_sheet WHERE score_sheet.Session='$session' AND score_sheet.Class='$class' AND score_sheet.Term='$term' AND score_sheet.ID_Number='$name' GROUP BY ID_Number ORDER BY ID_Number DESC");
...
<tr><td><hr color="#990000" size="1"></td></tr>
<tr>
<td><span class="style42">Name :</span>&nbsp;&nbsp;&nbsp;  <?php echo  $row['Name'] ; ?> &nbsp;&nbsp;&nbsp;&nbsp;Gender______________<span class="style55">&nbsp;&nbsp;&nbsp;&nbsp;ID.Number : </span>&nbsp; <?php echo $row['ID_Number']; ?> &nbsp;&nbsp;&nbsp; </td>
</tr>
<tr><td><hr color="#990000" size="1"></td></tr>
        <TD width="691"><span class="style42">Class : </span>&nbsp; <?php echo $row['Class']; ?> &nbsp;&nbsp;&nbsp;<span class="style42">Number in Class : </span> &nbsp; <?php echo $num_pos; ?> &nbsp;&nbsp; <span class="style42">Attendance </span>&nbsp;_______________&nbsp;<span class="style42">Days</span>__________ <span class="style42">Out of</span> __________  </TD>
<tr><td><hr color="#990000" size="1"></td></tr>
...
<tr><td><br><br><br><br></td> <td><center> <?php echo $nextTerm; ?> </center> </td><td>&nbsp;</td><td><center><?php echo $fees;  ?></center></td></tr>
</table>
<div align="left"><br>
    <span class="style49"><span class="style54">Promoted To</span>&nbsp;&nbsp;</span>&nbsp;_________________<span class="style49">&nbsp;</span><span class="style49">&nbsp;</span> <span class="style49"><span class="style42">To Repeat</span>&nbsp;&nbsp;</span>&nbsp;__________________ <span class="style49">&nbsp;&nbsp;<span class="style42">To Withdraw&nbsp;</span>&nbsp;&nbsp;</span>________________<span class="style49"><br><BR>
Reason For Advice</span>_____________________________________________________________________<span class="style52"><br><BR>
<span class="style40">Principal's Comment</span></span>____________________________________________________________________</div>
...
echo '<a href="print_result_single.php"> <input type="button"  value="Print This Page" onClick="window.print()"  /> </a>';
}
