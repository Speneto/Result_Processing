...
<form action="bursarlog.php" method="post">
<Center>
...
<tr><td>
        ...
        <tr  font face ="Britannic Bold" border="0" color="Red" size="500" ALIGN="CENTER">  <TH COLSPAN=4> <fieldset> Bursar LogIn </fieldset></TH>
