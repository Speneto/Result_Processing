...
<tr><td>
        ...
        <tr  font face ="Britannic Bold" border="0" color="Red" size="500" ALIGN="CENTER">  <TH COLSPAN=4> <fieldset> <p font size=0>Staff Login</fieldset></TH>
<th bgcolor="" colspan=2 align="right"><img src="indicator.GIF"  width="100" height="100" border="0"></th></TR>
        
		
  <div align="center" style="color:#000000">
  <tr>
 <td> Username	: <input type="text" name="username" id = "username" size="30"></td></tr>
 <tr>
 <td>
  Password	:<input type="password" name="password"  id = "password"size="30"></td></tr>
  <tr><td colspan="2">
  <input name="submit"  id="submit" type="submit" value="Log In"> </td> </tr> </div> 
